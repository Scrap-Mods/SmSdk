...
#   define MYGUI_IS_NATIVE_WCHAR_T     1
	...
	*/
	...
	class MYGUI_EXPORT _base_iterator: public MyGUIIterator<std::random_access_iterator_tag, value_type> { /* i don't know why the beautifier is freaking out on this line */
